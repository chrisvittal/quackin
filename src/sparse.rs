...
//! Here a sparse vector is just a `HashMap<T, f64>` where `T` satisfies the `Key` trait.

use std::collections::HashMap;
use super::Key;

/// Computes the dot product between two sparse vectors.
pub fn dot<T: Key>(a: &HashMap<T, f64>, b: &HashMap<T, f64>) -> f64 {
